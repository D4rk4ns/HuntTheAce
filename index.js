...
const success = new Audio("./cards/success.wav");
const fail = new Audio("./cards/fail.flac");

/* <div class="card">
<div class="card-inner">
    <div class="card-front">
        <img src="/cards/card-JackClubs.png" alt="" class="card-img">
    </div>
    <div class="card-back">
        <img src="/cards/card-back-Blue.png" alt="" class="card-img">
    </div>
</div>
</div> */
